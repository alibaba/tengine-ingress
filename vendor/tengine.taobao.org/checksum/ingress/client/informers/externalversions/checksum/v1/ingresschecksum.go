...
import (
	...
	v1 "tengine.taobao.org/checksum/ingress/client/listers/checksum/v1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TengineV1().IngressCheckSums(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TengineV1().IngressCheckSums(namespace).Watch(options)
			},
		},
